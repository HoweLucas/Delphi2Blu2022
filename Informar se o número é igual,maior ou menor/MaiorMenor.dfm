<Project xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
    <PropertyGroup>
        <ProjectGuid>{EAB0C7D3-790E-4B7E-8B88-22A42A4324F5}</ProjectGuid>
        ...
        <MainSource>MaiorMenor.dpr</MainSource>
    </PropertyGroup>
    ...
    <PropertyGroup Condition="'$(Base)'!=''">
        ...
        <SanitizedProjectName>MaiorMenor</SanitizedProjectName>
    </PropertyGroup>
    ...
    <ItemGroup>
        ...
        <DCCReference Include="maiorMenorOuIgual.pas">
            <Form>Form1</Form>
    ...
    <ProjectExtensions>
        ...
        <BorlandProject>
            <Delphi.Personality>
                <Source>
                    <Source Name="MainSource">MaiorMenor.dpr</Source>
                </Source>
            </Delphi.Personality>
            <Deployment Version="3">
                <DeployFile LocalName="Win32\Debug\MaiorMenor.exe" Configuration="Debug" Class="ProjectOutput">
                    <Platform Name="Win32">
                        <RemoteName>MaiorMenor.exe</RemoteName>
